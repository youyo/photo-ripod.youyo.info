      	...
      	<legend><h3><?php	echo t('Editor Dimensions')?></h3></legend>
			...
			<div class="clearfix">
				...
				<div class="input"><?php	
					...
					?>
				  <?php	echo Loader::helper('form')->text('CONTENTS_TXT_EDITOR_WIDTH', $textEditorWidth, array('class' => 'span5'))?>
				</div>
			</div>
			...
			<div class="clearfix">
				...
				<div class="input"><?php	
					...
					?>
				  <?php	echo Loader::helper('form')->text('CONTENTS_TXT_EDITOR_HEIGHT', $textEditorHeight, array('class' => 'span5'))?>
				</div>
			</div>
