		...
		<div class="span5" >
			...
			<div class="input">
				<select multiple name="fsID[]" class="chosen-select">
    				...
    				?>
						<option value="<?php	echo  $s->getFileSetID()?>"  <?php	 if (is_array($searchRequest['fsID']) && in_array($s->getFileSetID(), $searchRequest['fsID'])) { ?> selected="selected" <?php	 } ?>><?php	echo  $fsetName2; ?></option>
					<?php } ?>
